...
print(calculate_total_amount(2, 3)) # 100 + 30 = 130
print(calculate_total_amount(2, 3, 4)) # 100 + 30 + 20 = 150
print(calculate_total_amount(2, 3, 4, 1)) # 100 + 30 + 20 + 2 = 152
print(calculate_total_amount(2, 3, 4, 1, 3)) # 152 + 3 = 155
print(calculate_total_amount(2, 3, two_note=4)) # 130 + 8 = 138
print(calculate_total_amount(2, 3, two_note=4, five_note=1)) # 138 + 5 = 143
print(calculate_total_amount(3, two_note=4, five_note=1)) # error, no value for ten_note
